...
public class Monitor extends javax.swing.JInternalFrame {
    ...
    public Monitor() throws ClassNotFoundException {
        initComponents();
    ...
    public void dadosCliente(){
        ...
        String sql = "SELECT codigo,nome, qtd_pes,h_chega from cliente";
    ...
    public void mesaCliente(){
        
        String sql = "SELECT id_mesa_1 from mesa";
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Monitor de Atendimentos");
