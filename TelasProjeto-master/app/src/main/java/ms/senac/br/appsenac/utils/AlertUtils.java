...
public class AlertUtils {
    ...
    public static void alertSupport(Context context, String titulo, String message, final Runnable runnable) {
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(context);
        builder.setTitle(titulo).setMessage(message);
        String okString =  "OK";
        // Add the buttons
        builder.setPositiveButton(okString, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
    ...
    public static void alertSupportExcluirPost(final Context context, String titulo, String message, final Thread runnable) {
        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(context);
        builder.setTitle(titulo).setMessage(message);
