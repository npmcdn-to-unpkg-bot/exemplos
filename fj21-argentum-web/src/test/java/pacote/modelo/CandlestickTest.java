...
public class CandlestickTest {
	...
	public void precoMaximoNaoPodeSerMaiorQueMinimo() {
		...
		new Candle(abertura, fechamento, minimo, maximo, volume, Calendar.getInstance());
	}
	...
	public void valoresNaoPodemSerNulos() {
		...
		new Candle(abertura, null, minimo, maximo, volume, Calendar.getInstance());
	}
	...
	public void quandoAberturaEhIgualFechamentoEhAlta() {
		...
		Candle candlestick = new Candle(abertura, fechamento, minimo, maximo, volume, Calendar.getInstance());
